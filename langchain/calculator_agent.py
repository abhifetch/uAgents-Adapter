...
#from langchain_uagents.tools import UAgentRegisterTool, cleanup_uagent
...
agent_info = tool.invoke({
    "agent_obj": agent,
    "name": "calculator_agent_langchain_mailbox",
    "port": 8080,
    "description": "A calculator agent for evaluating mathematical arethmatic expressions to test the uAgentRegisterTool",
    "api_token": API_TOKEN,
